			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
				...
				<div>
					...
					<div class="relative">
						...
						<Datepicker bind:value={fechaDesde} availableTo={new Date()} placeholder="Seleccione una fecha" translationLocale="es-VE" dateFormat={{year: 'numeric', month: '2-digit', day: '2-digit'}} />
				...
				<div>
					...
					<div class="relative">
						<Datepicker bind:value={fechaHasta} availableFrom={fechaDesde} availableTo={new Date()} placeholder="Seleccione una fecha" translationLocale="es-VE" dateFormat={{year: 'numeric', month: '2-digit', day: '2-digit'}} />
